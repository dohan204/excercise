...
import React, { useEffect, useState, type ChangeEvent, type SetStateAction } from "react";
...
const ProductHeader = ({fieldName, setFieldName, keyword, setKeyword, button, setButton}: Props) => {
        ...
        <div className="w-full h-full flex flex-row gap-10">
            <div className="flex flex-2 gap-6 flex-col justify-between">
                ...
                <div className="flex flex-1 w-full flex-row justify-around">
                    ...
                    <ProductNewPupup open={popup === 'new'} setOpen={() => setPopup(null)} />
                </div>
            </div>
